...
>
<div className="max-w-3xl mx-auto bg-white/80 backdrop-blur-md 
p-6 rounded-xl shadow-xl border border-blue-100">


      <h2 className="text-2xl font-bold mb-4">
        Issue History: {history.name}
      </h2>

      <a
        href="/"
        className="bg-blue-600 text-white px-4 py-2 rounded shadow mb-4 inline-block"
      >
        Back
      </a>
