...
export default function WaterPointsPage() {
  ...
  return (
    ...
    >
      <h1 className="text-3xl font-bold text-blue-700 mb-6">Community Water Points</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {points.map((wp) => (
          ...
          >
            ...
            <div className="mt-2">
              {wp.isSafe ? (
                <span className="bg-green-100 text-green-700 px-2 py-1 rounded text-xs font-semibold">Safe</span>
              ) : (
                <span className="bg-red-100 text-red-700 px-2 py-1 rounded text-xs font-semibold">Unsafe</span>
              )}
            </div>
